        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              />
              <div className="absolute -inset-1 bg-gradient-to-r from-gamefi-yellow to-gamefi-yellow-glow rounded-lg blur opacity-0 animate-glow-soft"></div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <a 
              href="https://github.com/MrM002/BaseBadge" 
              target="_blank" 
            ...
            <a 
              href="https://farcaster.xyz/basebadge" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors duration-300 group"
            >
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-gray-400 text-center">
              © 2025 BaseBadge. Built with ❤️ on <span className="text-gamefi-blue">Base</span> Network.
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-6">
                <a 
                  href="mailto:0x0mr0m0@gmail.com" 
